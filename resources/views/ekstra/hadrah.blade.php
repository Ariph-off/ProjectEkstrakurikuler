...
<head>
  ...
  <title>Portal Hadrah - Home 1</title>
...
<body>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{ asset ('portal') }}/assets/img/hadra/hadrah 1.1.png" class="img-fluid animated img-pencaksilat">
      <h2>Welcome to Ekstrakurikuler <span>Hadrah</span></h2>
    </div>
  </section>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
            <h3>Apa yang dimaksud dengan <em>Hadrah</em></h3>
            <p> Hadrah adalah sebuah tradisi seni dan budaya yang berasal dari dunia Islam, terutama populer di berbagai negara di Timur Tengah, Asia Selatan, dan Asia Tenggara. Tradisi ini melibatkan pertunjukan musik, tarian, dan nyanyian yang seringkali dilakukan dalam konteks religius atau perayaan budaya. Hadrah seringkali dianggap sebagai bentuk seni yang mendalam dan berarti dalam budaya Islam.</p>
          </div>

          <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
            <div class="img">
              <img src="{{ asset ('portal') }}/assets/img/hadra/hadrah 1.0.png" alt="" class="img-fluid">
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="section-header">
            <h2>Jenis jenis Hadrah</h2>
          </div>


          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              <h4 align="center"><a class="stretched-link">Habsyi</a></h4>
              <p>Pukulan yang terdapat dalam Hadrah Habsyi ini terdengar cepat, dikarenakan adanya ritme di dalam lagu-lagu yang diiringinya berirama cepat. Jenis ini umum digunakan di dalam majelis-majelis Maulid Nabi.</p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              <h4 align="center"><a class="stretched-link">Al-Banjari</a></h4>
              <p>Jenis pukulan Hadrah ini sangat pelan dalam ketukan. Hal ini terdengar pada ketukan pembukaan dalam suatu lagu atau syair yang dilantunkan.</p>
            </div>
          </div><!-- End Service Item -->
        </div>
      </div>
    ...
    <section id="faq" class="faq">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row gy-4">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                    ...
                    Apa dasar dari Hadrah ?
                  </button>
                </h3>
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    penghayatan dan ekspresi rasa cinta, kasih sayang, dan pengabdian kepada Tuhan (Allah) serta Nabi Muhammad SAW dalam budaya Islam. Hadrah adalah bentuk penghormatan dan ibadah yang melibatkan unsur-unsur seni dan budaya.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    <i class="bi bi-question-circle question-icon"></i>
                    Apa ciri ciri dari Hadrah ?
                  </button>
                </h3>
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Musik dan Instrumen Tradisional, Tarian Khas, Nyanyian dan Selawat, Pesan Agama dan Moral, dan Penghormatan kepada Nabi Muhammad SAW
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="400">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3">
                    <i class="bi bi-question-circle question-icon"></i>
                    Apa fungsi dari Hadrah ?
                  </button>
                </h3>
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Ibadah dan Penghormatan, Pendidikan Agama, Perayaan Agama dan Hiburan
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <!-- <div class="accordion-item" data-aos="fade-up" data-aos-delay="500">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
                    <i class="bi bi-question-circle question-icon"></i>
                    Apa itu pendekar silat?
                  </button>
                </h3>
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    <i class="bi bi-question-circle question-icon"></i>
                    Pendekar adalah orang yang memiliki keahlian dalam seni bela diri dan menggunakan keahliannya tersebut untuk membela kebenaran, membela orang lemah dan tertindas, atau menegakkan keadilan dengan menentang sebuah kekuatan penindas.
                  </div>
                </div>
              </div># Faq item -->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="600">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-5">
                    <i class="bi bi-question-circle question-icon"></i>
                    Kenapa dinamakan Hadrah?
                  </button>
                </h3>
                <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Asal kata "hadrah" dapat dilacak kembali ke kata dalam bahasa Arab "حضرة" (hadhrah), yang secara harfiah berarti "kedatangan" atau "kedekatan." Dalam konteks hadrah, kata ini mengacu pada pengalaman spiritual atau kehadiran spiritual yang dirasakan oleh para penampil dan penonton selama pertunjukan. Hadrah sering kali dianggap sebagai cara untuk mendekatkan diri kepada Allah dan merasakan kehadiran-Nya dalam suasana yang khusyuk dan meriah
                  </div>
                </div>
              </div><!-- # Faq item-->
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("{{ asset ('portal') }}/assets/img/hadra/hadrah 1.3.png");'>&nbsp;</div>
        </div>
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Struktur Ekstrakurikuler Hadrah</h2>
          <p>Berikut merupakan struktur dari ekstrakurikuler hadrah</p>
        </div>
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{ asset ('portal') }}/assets/img/hadra/pelatih hadrah.png" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="400">
            <div class="team-member">
              <div class="member-img">
                <img src="{{ asset ('portal') }}/assets/img/hadra/pembina hadrah.png" class="img-fluid" alt="">
              </div>
              <div class="member-info">
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                ...
                <h4>Mohammad Ridwan Saidi, S.Pd</h4>
                <span>Pembina</span>
              </div>
            </div>
          </div><!-- End Team Member -->
