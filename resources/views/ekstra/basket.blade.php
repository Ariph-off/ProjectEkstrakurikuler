...
<body>
  ...
  <main id="main">
    ...
    <section id="featured-services" class="featured-services">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <h2 align="center">SEPUTAR BASKET</h2>

          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              <img src="{{asset('portal')}}/assets/img/basket/lapangan.png" width="100px" height="100px" line-right="50px">
              <h4><a href="" class="stretched-link">Lapangan</a></h4>
              <p>Lapangan bola basket berbentuk persegi panjang dengan dua standar ukuran, yakni panjang 28,7 meter dan
                lebar 15,2 meter untuk standar <b>National Basketball Association</b> dan panjang 28 meter dan lebar 15
                meter
                untuk standar <b>Federasi Bola Basket Internasional.</b></p>
            </div>
          </div><!-- End Service Item -->

          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              <img src="{{asset('portal')}}/assets/img/basket/basketball-player.png" width="100px" height="100px" line-right="50px">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              <img src="{{asset('portal')}}/assets/img/basket/time.png" width="100px" height="100px" line-right="50px">
              <h4><a href="" class="stretched-link">Waktu</a></h4>
              <p>Waktu permainan 4 x 10 menit jika berpedoman dengan aturan <b>Federasi Bola Basket Internasional</b>.
                Versi
                <b>National Basketball Association</b> waktu bermain adalah 4 x 12 menit. Di antara babak 1, 2, 3, dan
                babak 4
                terdapat waktu istirahat selama 10 menit.
              </p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              <img src="{{asset('portal')}}/assets/img/basket/basketball.png" width="100px" height="100px" line-right="50px">
    ...
    <!-- <a class="btn btn-danger" target="blank" href="coba.html"></a> -->
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
            <h3>Apasih ekstra basket itu?</h3> <br>
            <p>Ekstrakurikuler basket merupakan kegiatan ekstrakurikuler dari salah satu cabang olahraga bola besar
              yaitu basket yang dilaksanakan di luar jam pelajaran sekolah. Bola basket adalah olahraga bola berkelompok
              yang terdiri atas dua tim yang saling bertanding mencetak poin dengan memasukkan bola ke dalam keranjang
              lawan.
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
            <div class="img">
              <img src="{{asset('portal')}}/assets/img/basket/basket 1.0.png" alt="" class="img-fluid">
            </div>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
            ...
            <div class="content px-xl-5">
              <h3>Pertanyaan seputar tentang <strong>Ekstra Basket</strong></h3>
              <p>
            ...
            <div class="accordion accordion-flush px-xl-5" id="faqlist">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Tujuan dari ekstrakurikuler ini adalah agar peserta didik dapat menyalurkan minat, bakat, dan
                    kegemaran bermain bola basket, menambah pengalaman
                    baru, menambah teman dan mengisi waktu luang.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                ...
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Untuk tempat latihannya sendiri SMKN 1 Bondowoso telah memfasilitasinya, yaitu terletak di Lapangan
                    Indoor Sasana Krida SMKN 1 Bondowoso.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="600">
                ...
                <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Ekstrakurikuler Basket Smakensa ini memiliki pembina dan pelatihnya sendiri yang telah dipilih
                    sesuai dengan yang dibutuhkan. Jadi bukan hanya guru olahraga yang dapat melatih basket, untuk
                    pembinanya merupakan guru terpilih yang ada di SMKN 1 Bondowoso baik guru pengajar umum maupun guru
                    olahraga.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="500">
                ...
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    <i class="bi bi-question-circle question-icon"></i>
                    Persatuan Bola Basket Seluruh Indonesia disingkat <em><b>Perbasi</b></em> merupakan organisasi
                    pengatur olahraga
                    bola basket di Indonesia yang didirikan 23 Oktober 1951.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="400">
                ...
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Selain latihan antar peserta ekstra sendiri, ekstra Basket juga mengadakan sparing dengan sekolah
                    lain.
                  </div>
                </div>
              </div><!-- # Faq item-->
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Struktur Pengurus Basket</h2>
          ...
          <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
            <div class="team-member">
              ...
              <div class="member-info">
                ...
                <h4>Salwah Sabrina</h4>
                <span>Ketua Basket</span>
              </div>
            </div>
          </div><!-- End Team Member -->
