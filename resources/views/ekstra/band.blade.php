...
<head>
    ...
    <title>Portal band music - Home 1</title>
...
<body>
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
            <img src="{{asset('portal')}}/assets/img/band/band 1.0.png" class="img-fluid animated">
            <h2>Welcome to Ekstrakurikuler <span>BAND MUSIC</span></h2>
        </div>
    </section>
        ...
        <section id="featured-services" class="featured-services">
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <h2 align="center">Alat Music</h2>

                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
                        <div class="service-item position-relative">
                            <img src="{{asset('portal')}}/assets/img/band/gitarakystik.jpeg" width="100px" height="100px" line-right="50px">
                            <h4><a href="" class="stretched-link">gitar akustik</a></h4>
                            <p>Gitar adalah sebuah alat musik berdawai yang dimainkan dengan cara dipetik, umumnya menggunakan jari maupun plektrum. Gitar terbentuk atas sebuah bagian tubuh pokok dengan bagian leher yang padat sebagai tempat senar yang umumnya berjumlah enam didempetkan.
                            </p>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
                        <div class="service-item position-relative">
                            <img src="{{asset('portal')}}/assets/img/band/drum.jpeg" width="100px" height="100px" line-right="50px">
                            <h4><a href="" class="stretched-link">Drum</a></h4>
                            <p>Drum adalah kelompok alat musik perkusi yang terdiri dari kulit yang direntangkan dan dipukul dengan tangan atau sebuah batang atau biasanya disebut Stick drum. Selain kulit, drum juga digunakan dari bahan lain, misalnya plastik.
                            </p>
                        </div>
                    </div><!-- End Service Item -->
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
                        <div class="service-item position-relative">
                            <img src="{{asset('portal')}}/assets/img/band/keyboard.jpeg" width="100px" height="100px" line-right="50px">
                            <h4><a href="" class="stretched-link">Keyboard</a></h4>
                            <p>Apa Itu Alat Musik Keyboard? Alat musik keyboard merupakan sebuah alat musik yang memiliki bentuk serta cara dimainkan yang serupa dengan alat musik piano. Namun, yang membedakan alat musik keyboard dengan piano adalah, alat musik keyboard tidak memiliki pedal yang dimiliki piano di bagian bawahnya.</p>
                        </div>
                    </div><!-- End Service Item -->

                    <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
                        <div class="service-item position-relative">
                            <img src="{{asset('portal')}}/assets/img/band/gitar.jpeg" width="100px" height="100px" line-right="50px">
                            <h4><a href="" class="stretched-link">Gitar elecktrik</a></h4>
                            <p>Gitar elektrik atau gitar listrik adalah jenis gitar yang menggunakan beberapa pickup untuk mengubah bunyi atau getaran dari string gitar menjadi arus elektrik yang akan dikuatkan kembali dengan menggunakan seperangkat amplifier dan pengeras suara.</p>
                        </div>
                    </div><!-- End Service Item -->
            ...
            <div class="container" data-aos="zoom-out">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
                        <div class="img">
                            <img src="{{asset('portal')}}/assets/img/band/band 1.1.png" alt="" class="img-fluid">
                        </div>
                    </div>
                            ...
                            <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                                <h3 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                                        ...
                                        Apa manfaat mengikuti ekstra band music?
                                    </button>
                                </h3>
                                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                    <div class="accordion-body">
                                        Berikut ini merupakan beberapa manfaat bermain alat musik yang bisa Anda dapatkan:
                            ...
                            <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                                <h3 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                                        <i class="bi bi-question-circle question-icon"></i>
                                        apa saja yang ada di dalam band?
                                    </button>
                                </h3>
                                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                    <div class="accordion-body">
                                        Band merupakan sebuah kelompok musik yang terdiri dari beberapa personil dan setiap personil mempunyai peran tersendiri untuk memainkan instrumen atau alat musik sesuai kemampuan mereka. Biasanya dalam satu band terdiri dari viokalist, drummer, keyboardist, gitarist dan basist.
                                    </div>
                                </div>
                            </div><!-- # Faq item-->
                            ...
                            <div class="accordion-item" data-aos="fade-up" data-aos-delay="400">
                                <h3 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3">
                                        <i class="bi bi-question-circle question-icon"></i>
                                        berapa personil yang di butuhkan untuk band?
                                    </button>
                                </h3>
                            ...
                            <div class="accordion-item" data-aos="fade-up" data-aos-delay="500">
                                <h3 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
                                        <i class="bi bi-question-circle question-icon"></i>
                                        mengapa sepak bola membutuhkan pemain depan?
                                    </button>
                                </h3>
                                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                    <div class="accordion-body">
                                        <i class="bi bi-question-circle question-icon"></i>
                                        Meskipun peran utama striker adalah mencetak gol, striker juga harus membantu timnya dalam pertahanan. Mereka harus bisa menekan pemain lawan dan membantu timnya memenangkan bola di lapangan tengah. Striker yang cerdas akan berkontribusi untuk memperkuat pertahanan tim mereka dan mencegah gol dari lawan.
                                    </div>
                                </div>
                            </div><!-- # Faq item-->
