...
<body>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{asset('portal')}}/assets/img/pencaksilat/ikon.png" width="350px" class="img-fluid animated">
      <h2>Welcome to Ekstrakurikuler <span>Pencak Silat</span></h2>
    </div>
  </section>
    ...
    <section id="featured-services" class="featured-services">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <h2 align="center">Aliran seni bela diri Pencak silat</h2>
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
            <h3>Apa yang dimaksud dengan <em>Pencak Silat</em></h3>
            <p> Pencak silat atau silat adalah suatu seni bela diri tradisional yang berasal dari Kepulauan Melayu. Seni bela diri ini secara luas dikenal di Indonesia, Malaysia, Brunei, dan Singapura, Filipina selatan, dan Thailand selatan sesuai dengan penyebaran berbagai suku bangsa Nusantara.</p>
          </div>

          <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
            <div class="img">
              <img src="{{asset('portal')}}/assets/img/pencaksilat/gambar3.jpeg" alt="" class="img-fluid">
            </div>
          </div>
    ...
    <section id="faq" class="faq">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row gy-4">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                    ...
                    Apa tujuan dari seni bela diri Pencak Silat?
                  </button>
                </h3>
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Dari definisi di atas, dapat disimpulkan, bahwa pencak silat adalah sebagai hasil budaya manusia Indonesia untuk membela, mempertahankan eksistensi, dan integritas terhadap lingkungan hidup, alam sekitarnya, untuk mencapai keselarasan hidup guna meningkatkan iman dan takwa kepada Allah SWT.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    <i class="bi bi-question-circle question-icon"></i>
                    Apa teknik dasar Pencak Silat?
                  </button>
                </h3>
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Teknik dasarnya meliputi kuda-kuda, sikap pasang, pola langkah, pukulan, tendangan, tangkisan, kuncian, guntingan dan sikap berbaring.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="600">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-5">
                    <i class="bi bi-question-circle question-icon"></i>
                    Pencak Silat termasuk cabang apa?
                  </button>
                </h3>
                <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Pencak silat juga adalah salah satu cabang olahraga beladiri yang asli dilahirkan di rumpun melayu, khususnya Indonesia.
                  </div>
                </div>
              </div><!-- # Faq item-->
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("{{asset('portal')}}/assets/img/pencaksilat/faq.jpg");'>&nbsp;</div>
        </div>
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
          ...
          <div class="row g-0 portfolio-container">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('portal')}}/assets/img/pencaksilat/gambar1.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>App 1</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar1.jpeg" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->

            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-product">
              <img src="{{asset('portal')}}/assets/img/pencaksilat/gambar2.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Product 1</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar2.jpeg" title="Product 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->

            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-branding">
              <img src="{{asset('portal')}}/assets/img/pencaksilat/gambar3.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Branding 1</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar3.jpeg" title="Branding 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->

            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-books">
              <img src="{{asset('portal')}}/assets/img/pencaksilat/gambar4.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Books 1</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar4.jpeg" title="Branding 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->

            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app">
              <img src="{{asset('portal')}}/assets/img/pencaksilat/gambar5.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>App 2</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar5.jpeg" title="App 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->

            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-product">
              <img src="{{asset('portal')}}/assets/img/pencaksilat/gambar6.jpeg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Product 2</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar6.jpeg" title="Product 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-branding">
              ...
              <div class="portfolio-info">
                <h4>Branding 2</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar1.jpeg" title="Branding 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-books">
              ...
              <div class="portfolio-info">
                <h4>Books 2</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar2.jpeg" title="Branding 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app">
              ...
              <div class="portfolio-info">
                <h4>App 3</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar3.jpeg" title="App 3" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-product">
              ...
              <div class="portfolio-info">
                <h4>Product 3</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar4.jpeg" title="Product 3" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-branding">
              ...
              <div class="portfolio-info">
                <h4>Branding 3</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar5.jpeg" title="Branding 2" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-books">
              ...
              <div class="portfolio-info">
                <h4>Books 3</h4>
                <a href="{{asset('portal')}}/assets/img/pencaksilat/gambar6.jpeg" title="Branding 3" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                <a href="portfolio-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
              </div>
            </div><!-- End Portfolio Item -->
