...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset ('portal') }}/assets/drumband/img/logo.png" rel="icon">
 ...
 <header id="header" class="header fixed-top" data-scrollto-offset="0">
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{ asset ('portal') }}/assets/img/drumband/Desain tanpa judul.png" class="img-fluid animated">
      <h2>Welcome to Ekstrakurikuler <span>Marching Band</span></h2> 
    </div>
  </section>
    ...
    <section id="featured-services" class="featured-services">
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <h2 align="center">Berbagai Kelompok Di Marching Band</h2>

          <div class=" col-md-4 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              <img src="{{ asset ('portal') }}/assets/img/drumband/1.png"  width="100px" height="100px" line-right="50px">
              <h4><a href="" class="stretched-link">Brass</a></h4>
              <p>Kelompok Brass di dalam Marching Band adalah kelompok yang memainkan alat tiup. Bertugas untuk memainkan chord dan melodi serta memainkan dinamika pada lagu. Klompok ini pun biasanya dibagi menjadi tiga kelompk yaitu hight, midle dan low. Setiap kelompok memainkan instrumen yang berbeda-beda pula</p>
            </div>
          </div><!-- End Service Item -->

          <div class=" col-md-4 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              <img src="{{ asset ('portal') }}/assets/img/drumband/note1.png"  width="100px" height="100px" line-right="50px">
              <h4><a href="" class="stretched-link">Perkusi/Battery
              </a></h4>
              <p>Kelompok perkusi memiliki peran penting karena merekalah yang memainkan tempo dan menjadi patokan dari semua pemain. Instrumen yang dimainkan pun bermacam-macam yaitu:
              </div>
          </div><!-- End Service Item -->

          <div class=" col-md-4 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              <img src="{{ asset ('portal') }}/assets/img/drumband/note2.png"  width="100px" height="100px" line-right="50px">
              <h4><a href="" class="stretched-link">PIT ( Percussion In Tone)
              </a></h4>
              <p>PIT adalah kelompok perkusi yang posisinya berada di bagian paling depan dan tidak ikut dalam baris-berbaris untuk membentuk formasi. Kelompok ini memainkan instrumen perkusi yang bernada. Instrumen-instrumen yang biasa dimainkan adalah:
              </p>
            </div>
          </div><!-- End Service Item -->
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
            <div class="img">
              <img src="{{ asset ('portal') }}/assets/img/drumband/Drum Major Marching Band Leader Wood.jpeg" alt="" class="img-fluid">
            </div>
          </div>
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                    ...
                    Mengapa marching band juga di sebut sebagai orkes barisan?                  
                  </button>
                </h3>
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Marching Band adalah orkes barisan, yang artinya sekelompok orang yang memainkan satu atau beberapa lagu yang menggunakan gabungan dari beberapa alat musik.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    <i class="bi bi-question-circle question-icon"></i>
                    Marching band mempunyai divisi apa saja?
                  </button>
                </h3>
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="400">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3">
                    <i class="bi bi-question-circle question-icon"></i>
                    Siapa yang memimpin marching band?
                  </button>
                </h3>
                <div id="faq-content-3" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Drum Major, atau Field Commander, atau Komandan Lapangan atau Penatarama adalah pemimpin dari suatu penampilan marching band yang diperankan oleh satu atau dua orang yang memimpin penampilan di atas panggung ataupun podium.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="500">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
                    <i class="bi bi-question-circle question-icon"></i>
                    Apa fungsi dari marching band?
                  </button>
                </h3>
                <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    <i class="bi bi-question-circle question-icon"></i>
                    Penampilan marching band pada mulanya adalah sebagai pengiring parade perayaan ataupun festival yang dilakukan di lapangan terbuka dalam bentuk barisan dengan pola yang tetap dan kaku, serta memainkan lagu-lagu mars.
          ...
          <div class="row g-0 portfolio-container">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app">
              ...
              <div class="portfolio-info">
                <h4>App 1</h4>
                <a href="{{ asset ('portal') }}/assets/img/drumband/foto.jpg" title="App 1" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
