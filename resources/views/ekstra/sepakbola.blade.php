...
<body>
  ...
  <section id="hero-animated" class="hero-animated d-flex align-items-center">
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      <img src="{{asset('portal')}}/assets/img/sepak bola/satu.png" class="img-fluid animated">
      <h2>Welcome to Ekstrakurikuler <span>SEPAK BOLA</span></h2>
    </div>
  </section>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              <img src="{{asset('portal')}}/assets/img/sepak bola/football.png" width="100px" height="100px" line-right="50px">
              <h4><a href="" class="stretched-link">Pemain Bertahan atau Bek</a></h4>
              <p>Posisi ini juga dikenal sebagai stoper. Tugas utamanya adalah menghentikan pemain lawan untuk mendekati gawang dan mencetak gol di posisi tengah lapangan dan membuang bola dari area penalti.
              </p>
            </div>
          </div><!-- End Service Item -->
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
            <h3>Apa pengertian <em>sepak bola</em></h3>
            <p> sepak bola adalah permainan beregu di lapangan, menggunakan bola sepak dari dua kelompok yang berlawanan yang masing-masing terdiri atas sebelas pemain, berlangsung selama 2x45 menit, kemenangan ditentukan oleh selisih gol yang masuk ke gawang lawan.</p>
          </div>

          <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
            <div class="img">
              <img src="{{asset('portal')}}/assets/img/sepak bola/bolaa.jpg" alt="" class="img-fluid">
            </div>
          </div>
    ...
    <section id="faq" class="faq">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row gy-4">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                    ...
                    Mengapa sepak bola membutuhkan Kiper?
                  </button>
                </h3>
                <div id="faq-content-1" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Peran penjaga gawang atau kiper sangat penting dalam sebuah pertandingan sepak bola. Kiper bukan hanya berperan sebagai pintu terakhir yang harus dilewati lawan ketika akan mencetak skor.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                    <i class="bi bi-question-circle question-icon"></i>
                    mengapa sepak bola membutuhkan pemain bertahan ?
                  </button>
                </h3>
                <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                  <div class="accordion-body">
                    Tak kalah penting dari dua posisi sebelumnya, bek merupakan posisi pemain sepak bola yang bertugas sebagai lini pertahanan akhir untuk mencegah lawan mencetak gol. Hal ini dilakukan dengan mematahkan serangan, merebut bola dari pemain lawan, dan banyak lainnya.
                  </div>
                </div>
              </div><!-- # Faq item-->
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="400">
                <h3 class="accordion-header">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3">
                    <i class="bi bi-question-circle question-icon"></i>
                    mengapa sepak bola membutuhkan pemain tengah?
                  </button>
                </h3>
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("{{asset('portal')}}/assets/img/sepak bola/faq.jpg");'>&nbsp;</div>
        </div>
