        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark ">
                <div class="container-fluid">
                    <svg xmlns="kuli" width="16" height="16" fill="#fff" class="bi bi-egg-fried"
                        viewBox="0 0 16 16">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link act" aria-current="page" href="">Beranda</a>
                            </li>
                            <li class="nav-item">
            ...
            <!--navbar ends here -->
            <div class="midlle">
                <h1 class="text-white fw-bold display-3">Membantu anda menemukan<br> <span class="theme-text">ekstra
